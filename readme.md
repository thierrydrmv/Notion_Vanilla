# Notion Vanilla
 ...
 [Access the Project](https://notion-vanilla-six.vercel.app/)


## 📝 About

Application that simulates the notion editing text in real time.
...
- Develop a text editor that can change div tags to h1.
